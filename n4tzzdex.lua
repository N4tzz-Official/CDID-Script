...
for i = 10, 100, 10 do
    print("N4tzzHub | Bypassing Security... [✅" .. i .. "%]")
    wait(0.5)
end
...
Main = (function()
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="Developed by N4tzzHub",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
